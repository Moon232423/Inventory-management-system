    ...
    for (int i = 0; i < itemCount; i++) {
        if (inventory[i].id == id) {
            ...
            if (quantity > inventory[i].quantity) {
                ...
                printf("\t \tYour total bill is = %.2f taka only\n",total);
                printf("\nPlease, choose a payment method to complete the order:\n");
                printf("-----------------------------------------------------\n\n");
...
void cancelOrder() {
    ...
    printf("\nPress Enter to Back.......\n");
    getchar(); getchar(); // Wait for user input to return
}
...
void salesReport() {
    ...
    printf("-----------------------------------------------\n");
    printf("Item ID\tItem Name\tQuantity Sold\tTotal Sales\n");
    printf("-----------------------------------------------\n");

    // Iterate through all orders and calculate the sales for each item
    for (int i = 0; i < orderCount; i++) {
        for (int j = 0; j < itemCount; j++) {
    ...
    printf("\nPress Enter to Return to Menu...\n");
    getchar(); getchar();  // Wait for user input to return to the menu
}
